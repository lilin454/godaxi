...
export const RouteIntro = () => {
  ...
  const translations: any = {
    "zh-TW": {
      ...
      stat1_title: "建議出發時間",
      stat1_content: "建議 9:30 從中壢火車站出發，準時發車",
      stat2_title: "全程交通服務",
      ...
      transport_step1_desc: "參與者只需在集合時間（建議 9:30 前）自行抵達出發起點「中壢火車站」集合。現場將有活動接待人員為您發分實體線索探險包與道具包。",
      ...
      transport_highlight_desc: "有別於行色匆匆的傳統走馬看花或繁瑣的自由行規劃。我們為您承包全程所有的交通移動服務與道具指引。全家或親友在车上能輕鬆交流、小憩，隨後帶著最飽滿的精力前進景點，全神貫注於實境解謎的情感協作與探索樂趣！",
      outro_title: "「不是大人等小孩，是全家一起解謎！」",
      outro_desc: "透過互動任務與文化探索，創造屬於家庭的共同回憶。現在就預訂冒險旅程，為週末刻下一段難忘的歡笑旅程！",
      booking_btn: "立即預約冒險",
      puzzle_btn: "探索實境玩法",
      story_btn: "觀看故事序章",
      s1: { title: "中壢火車站（集合出發）", subtitle: "🚉 集合接駁・開啟冒險旅程", summary: "冒險隊伍熱情集合，領取道具箱與專屬包車，出發前進！", desc: "大家於 9:30 前在「中壢火車站」集合，與接待專員會合。領取精美實體線索探索包、解謎道具以及隊伍小手冊。隨後全員登上專屬遊覽包車前往客家文化探險起點，免除轉乘與開車找車位的體力負擔，帶著飽滿的好奇心，一同開啟今日的實境解謎冒險！", hl: ["中壢車站便攜集合", "領取實體精美道具", "全員包車安心啟程"], tips: "請於 09:20 前抵達集合地點，以確保全體成員順利在 9:30 準時發車喔！" },
      s2: { title: "三坑鐵馬道", subtitle: "🚴 水圳・農村・生態體驗", summary: "沿著古老水圳展開探索，騎自行車在微風中解鎖第一道客家謎題。", desc: "10:10 抵達風景幽靜、平緩安全的三坑鐵馬道，沿著古老的水圳波光粼粼。全家人將換乘協力車/單車，一邊呼吸大自然芬多精，一邊沿著水圳前進。根據手卷與地圖尋找斑駁的地標線索，共同解開客家農家生態與百年水利文化的秘密謎底！", hl: ["悠閒水圳單車行", "綠意裡的尋寶任務", "探尋百年農村水利"], tips: "我們會統一準備、租乘安全的單車或協力車，讓大家遊玩得安心又省力！" },
      s3: { title: "大溪老街", subtitle: "🍢 巴洛克街區・美食午餐任務", summary: "在繁華迷人的巴洛克牌樓下吃喝，一邊大啖美食一邊探索線索！", desc: "11:30 登陸享譽盛名的大溪老街。抬頭欣賞刻有複雜雕花的地標性巴洛克牌樓立面。尋寶隊在這裡要展開好玩又好吃的「美食收集大冒險」，品嚐熱騰騰的滷黑豆干、香Q客家牛汶水麻糬！原來美食的外包裝與地景可以拼出完美契合的下一關解密鑰匙！", hl: ["巴洛克雕花牌樓巡禮", "大溪經典老阿伯豆干", "感官味蕾與謎題整合"], tips: "我們為名勝老街留有充足的遊玩與午餐時光，快帶著大家的尋寶食譜出發吧！" },
      s4: { title: "大溪木藝生態博物館", subtitle: "🪵 傳統木器・匠人工藝考驗", summary: "參觀溫潤木造無牆博物館，解構傳統卡榫智慧，揭開歷史真相！", desc: "12:20 來到保存大溪傳統歷史的木藝生態博物館群。關卡引導孩子與父母一同觀察不用任何釘子便能緊密接合的「傳統榫卯卡榫」，在精妙無比的歷史大木器房與日式歷史建築中徜徉、解密，破譯木藝匠人的千古智慧！", hl: ["巧奪天工卡榫拆解", "無牆日式老房建築群", "在工藝美學中尋求解答"], tips: "館內藏有許多精緻手工藝展品與木件，動手闖關時記得溫柔對待展館設施喔！" },
      s5: { title: "桃園市客家文化館", subtitle: "🎵 影音多媒體・音樂與童趣互動", summary: "沉浸在多媒體影音世界裡，在歡樂的客家音樂中解題學客語！", desc: "14:40 前進結合音樂與文學藝術的桃園市客家文化館。利用館內豐富的影音互動裝置、童趣感十足的多媒體關卡，全家人攜手破解一系列關於客家歌謠與歷史事蹟的語音謎題，在歡笑好玩的情境中輕鬆學習日常客語！", hl: ["多媒體互動數位解謎", "客家歌謠與文學探索", "童趣無窮的影音體驗"], tips: "展示區擁有很多舒適冷氣房與趣味數位台機，下午造訪再合適不過！" },
      s6: { title: "鍾肇政文學生活園區", subtitle: "✍️ 文學發源・日式宿舍檜木宿舍群", summary: "探訪巨著《魯冰花》寫作故居，在榻榻米檜木香中解讀最後的謎底。", desc: "16:00 造訪巨作《魯冰花》誕生地。這裡保留並修復了當年的日式宿舍群建築。全家人漫步在檜木飄香的榻榻米及木廊下，尋找遺留在鍾大師稿紙中的筆觸和情感，將收集的一日答案拼出最後之密！並在現場榮獲專屬徽章！", hl: ["魯冰花文學起點", "古典日式木造宿舍群", "終極秘密揭曉與榮譽加冕"], tips: "踏上百年日宿舍群需要穿著襪子入內，請遵守館員參觀指引喔！" },
      s7: { title: "啟程回中壢火車站", subtitle: "🚌 回程接駁・精彩交流", summary: "登上寬敞舒適的回程包車，輕鬆歇息並交流一整天精彩的冒險回憶。", desc: "17:00 闖關成就集滿！大家在返程的專屬包車上放鬆身心。回顧今日全體無間的配合，在車上看看大家一路闖關留下的搞怪、歡笑全家照，把桃園大溪的美好客家行囊溫馨帶回家！", hl: ["包車返程免去開車疲憊", "旅程冒險故事精彩回首", "夥伴溫情交流分享"], tips: "專車預計 30 分鐘即可安全返抵，大夥可以在車上稍作小憩充電。" },
      s8: { title: "抵達中壢火車站", subtitle: "🚉 滿載而歸・冒險圓滿落幕", summary: "大約 17:45 抵達中壢火車站，收穫感動與代際歡笑、完美散會！", desc: "17:45 包車安穩將大家送抵出發起點「中壢火車站」，這場融合歷史、美食、木藝卡榫、客語與文學的一日深度探險在暖心的笑容中歡樂成行、圓滿落幕！大人與孩子都在通力協作中看見了彼此更棒的一面！", hl: ["安全返回中壢車站", "帶走充實的文化能量", "永遠封存的親子默契"], tips: "下車時別忘了隨身攜帶您的冒險包道具和特製實體金屬徽章喔，祝大家回程平順！" }
    },
    "zh-CN": {
      back: "返回首页",
      ...
      stat1_title: "建议出发时间",
      stat1_content: "建议 9:30 从中坜火车站出发，准时发车",
      stat2_title: "全程交通服务",
      ...
      transport_step1_desc: "参与者只需在集合时间（建议 9:30 前）自行抵达出发起点“中坜火车站”集合。现场将有活动接待人员为您分发实体线索探险包与道具包。",
      ...
      puzzle_btn: "探索实境玩法",
      story_btn: "观看故事序章",
      s1: { title: "中坜火车站（集合出发）", subtitle: "🚉 集合接驳・开启冒险旅程", summary: "冒险队伍热情集合，领取道具箱与专属包车，出发前进！", desc: "大家于 9:30 前在“中坜火车站”集合，与接待专员会合。领取精美实体线索冒险包、解密道具以及队伍小手册。随后全员登上专属游览包车前往客家文化探险起点，免除转乘与开车找车位的体力负担，带着饱满的好奇心，一同开启今日的实境解谜冒险！", hl: ["中圪车站便捷集合", "领取实体精美道具", "全员包车安心启程"], tips: "请于 09:20 前抵达集合地点，以确保全体成员顺利在 9:30 准时发车喔！" },
      s2: { title: "三坑铁马道", subtitle: "🚴 水圳・农村・生态体验", summary: "沿着古老水圳展开探索，骑自行车在微风中解锁第一道客家谜题。", desc: "10:10 抵达风景幽静、平缓安全的三坑铁马道，沿着古老的水圳波光粼粼。全家人将换乘协力车/单车，一边呼吸大自然芬多精，一边沿着水圳前进。根据手卷与地图寻找斑驳的地标线索，共同解开客家农家生态与百年水利文化的秘密谜底！", hl: ["悠闲水圳单车行", "绿意里的寻宝任务", "探寻百年农村水利"], tips: "我们会统一准备、租乘安全的单车或协力车，让大家游玩得安心又省力！" },
      s3: { title: "大溪老街", subtitle: "🍢 巴洛克街区・美食午餐任务", summary: "在繁华迷人的巴洛克牌楼下吃喝，一边大啖美食一边探索线索！", desc: "11:30 登陆享誉盛名的大溪老街。抬头欣赏刻有复杂雕花的地标性巴洛克牌楼立面。寻宝队在这里要展开好玩又好吃的内容“美食收集大冒险”，品尝热腾腾的卤黑豆干、香Q客家牛汶水麻糬！原来美食的外包装与地景可以拼出完美契合的下一关解密钥匙！", hl: ["巴洛克雕花牌坊巡礼", "大溪经典老阿伯豆干", "感官味蕾与谜题整合"], tips: "我们为名胜老街留有充足的游玩与午餐时光，快带着大家的寻宝食谱出发吧！" },
      s4: { title: "大溪木艺生态博物馆", subtitle: "🪵 传统木器・匠人工艺考验", summary: "参观温润木造无墙博物馆，解构传统榫卯智慧，解开历史真相！", desc: "12:20 来到保存大溪传统历史的木艺生态博物馆群。关卡引导孩子与父母一同观察不用任何钉子便能紧密接合的“传统榫卯”，在精妙无比的历史大木器房与日式历史建筑中徜徉、解密，破译木艺匠人的千古智慧！", hl: ["巧夺天工卡榫拆解", "无墙日式老房建筑群", "在工艺美学中寻求解答"], tips: "馆内藏有许多精致手工艺展品与木件，动手闯关时记得温柔对待展馆设施喔！" },
      s5: { title: "桃园市客家文化馆", subtitle: "🎵 影音多媒体・音乐与童趣互动", summary: "沉浸在多媒体影音世界里，在欢乐的客语音乐中解题学客语！", desc: "14:40 前进结合音乐与文学艺术的桃园市客家文化馆。利用馆内丰富的影音互动装置、童趣感十足的多媒体关卡，全家人携手破解一系列关于客家歌谣与历史事迹的语音谜题，在欢笑好玩的情景中轻松学习日常客语！", hl: ["多媒体互动数字解谜", "客家歌词与文学探索", "童趣无穷的影音体验"], tips: "展示区有很多舒适空调房与趣味数字台机，下午造访再合适不过！" },
      s6: { title: "钟肇政文学生活园区", subtitle: "✍️ 文学发源・日式宿舍桧木宿舍群", summary: "探访巨著《鲁冰花》写作故居，在榻榻米桧木香中解读最后的谜底。", desc: "16:00 造访巨作《鲁冰花》诞生地。这里保留并修复了当年的日式宿舍群建筑。全家人漫步在桧木飘香的榻榻米及木廊下，寻找遗留在钟大师稿纸中的笔触和情感，将收集的一日答案拼出最后之密！并在现场荣获专属徽章！", hl: ["鲁冰花文学起点", "古典日式木造宿舍群", "终极秘密揭晓与荣誉加冕"], tips: "踏上百年日宿舍群需要穿着袜子入内，请遵守馆员参观指引喔！" },
      s7: { title: "启程回中坜火车站", subtitle: "🚌 回程接驳・精彩交流", summary: "登上宽敞舒适的回程包车，轻松歇息并交流一整天精彩的冒险回忆。", desc: "17:00 闯关成就集满！大伙在返程的专属包车上放松身心。回顾今日全员无间的配合，在车上看看大家一路闯关留下的搞怪、欢笑全家照，把桃园大溪的美好客家行囊温馨带回家！", hl: ["包车返程免去开车疲惫", "旅程冒险故事精彩回头", "伙伴温情交流分享"], tips: "专车预计 30 分钟即可安全返抵，大伙可以在车上稍作小憩充电。" },
      s8: { title: "抵达中坜火车站", subtitle: "🚉 满载而归・冒险圆满落幕", summary: "大约 17:45 抵达中坜火车站，收获感动与代际欢笑、完美散会！", desc: "17:45 包车安稳将大家送抵出发起点“中坜火车站”，这场融合历史、美食、木艺榫卯、客语与文学的一日深度探险在暖心的笑容中欢乐成行、圆满落幕！大人与孩子都在通力协作中看见了彼此更棒的一面！", hl: ["安全返回中坜车站", "带走充实的文化能量", "永远封存的亲子默契"], tips: "下车时别忘了随身携带您的冒险包道具和特制实体金属徽章喔，祝大家回程平顺！" }
    },
    "en": {
      back: "Back Home",
      ...
      stat1_content: "Suggested 9:30 from Zhongli Railway Station, prompt departure.",
      ...
      stay_time: "Arrival Time: ",
      collapse: "Collapse",
      expand: "Read More",
      tips_label: "💡 Adventure Tips:",
      transport_title: "🚌 Assembly & Shuttle Service",
      transport_step1_title: "Arrive on Time",
      transport_step1_desc: "Meet at Zhongli Railway Station (before 9:30 ). Staff will distribute kits and props.",
    ...
    "vi": {
      ...
      stat1_content: "Gợi ý 9:30 từ ga Trung Lịch, khởi hành đúng giờ.",
      ...
      stay_time: "Thời gian đến: ",
      collapse: "Thu gọn",
      expand: "Xem thêm",
      tips_label: "💡 Mẹo nhỏ cho đoàn:",
      transport_title: "🚌 Dịch vụ đưa đón & Tập trung",
      transport_step1_title: "Đến đúng giờ",
      transport_step1_desc: "Tập trung tại ga Trung Lịch (trước 9:30). Nhân viên sẽ phát bộ dụng cụ và đạo cụ giải đố.",
      ...
      s1: { title: "Ga Trung Lịch (Tập trung)", subtitle: "🚉 Gặp mặt & Xe đón • Bắt đầu", summary: "Tập trung với tâm thế hào hứng, nhận trang bị và lên xe!", desc: "Gặp gỡ nhân viên tại ga Trung Lịch trước 9:30. Nhận bộ dụng cụ và sách hướng dẫn đẹp mắt. Sau đó lên xe buýt riêng đến điểm văn hóa Hakka đầu tiên—không căng thẳng lái xe, chỉ có sự tò mò thuần túy!", hl: ["Tập trung thuận tiện", "Đạo cụ thực tế đẹp mắt", "Khởi hành an toàn bằng xe riêng"], tips: "Vui lòng đến lúc 09:20 để đảm bảo cả đoàn khởi hành đúng 9:30!" },
      s2: { title: "Đường xe đạp Tam Hàng", subtitle: "🚴 Kênh đào • Làng quê • Sinh thái", summary: "Đạp xe dọc theo các kênh cổ và giải mã bí ẩn Hakka đầu tiên.", desc: "Đến đường Tam Hàng lúc 10:10. Gia đình chuyển sang xe đạp đôi hoặc xe đạp đơn. Đạp dọc theo kênh nước lấp lánh, hít thở không khí trong lành và tìm manh mối để giải mã bí mật văn hóa nước trăm năm!", hl: ["Đạp xe thư giãn bên kênh", "Săn kho báu giữa màu xanh", "Khám phá thủy lợi cổ xưa"], tips: "Xe đạp được chuẩn bị sẵn để đảm bảo an toàn và chuyến đi không tốn sức!" },
      s3: { title: "Phố cổ Daxi", subtitle: "🍢 Khu phố Baroque • Ăn uống & Giải đố", summary: "Ăn uống dưới những mái hiên Baroque quyến rũ trong khi tìm manh mối!", desc: "Đến phố cổ Daxi nổi tiếng lúc 11:30. Chiêm ngưỡng các vòm cửa Baroque tinh xảo. Bắt đầu 'Cuộc phiêu lưu ẩm thực'—thủ đậu phụ kho nóng hổi và bánh mochi Hakka dai ngon! Sử dụng bao bì thực phẩm để tìm chìa khóa tiếp theo!", hl: ["Tham quan kiến trúc Baroque", "Đậu phụ kho nổi tiếng", "Kết hợp vị giác và giải đố"], tips: "Chúng tôi dành đủ thời gian để tham quan và ăn trưa. Hãy tận hưởng thực đơn săn kho báu của bạn!" },
      s4: { title: "Bảo tàng Sinh thái Gỗ", subtitle: "🪵 Đồ gỗ • Thử thách tay nghề", summary: "Tham quan bảo tàng mở để khám phá kiến trúc mộng gỗ truyền thống.", desc: "12:20: Thăm cụm bảo tàng Gỗ. Nhiệm vụ hướng dẫn cha mẹ và trẻ em quan sát 'mộng gỗ truyền thống'—những kết nối chặt chẽ không dùng đinh. Giải mã trí tuệ ngàn năm của các thợ mộc trong những ngôi nhà Nhật cổ!", hl: ["Thử thách mộng gỗ điêu luyện", "Kiến trúc nhà Nhật cổ", "Tìm lời giải trong mỹ thuật"], tips: "Bảo tàng trưng bày nhiều món đồ thủ công tinh xảo. Hãy nhẹ tay khi tham gia giải đố!" },
      s5: { title: "Bảo tàng Văn hóa Hakka", subtitle: "🎵 Đa phương tiện • Âm nhạc & Tương tác", summary: "Đắm mình trong thế giới số và học tiếng Hakka qua âm nhạc vui nhộn!", desc: "14:40: Đến Bảo tàng Văn hóa Hakka Đào Viên. Sử dụng thiết bị âm thanh hình ảnh và các trạm tương tác. Gia đình cùng giải mã các câu đố âm thanh về bài hát và lịch sử, học tiếng Hakka trong không khí vui vẻ!", hl: ["Giải đố tương tác kỹ thuật số", "Khám phá nhạc & văn học Hakka", "Niềm vui âm thanh hình ảnh"], tips: "Bảo tàng có điều hòa mát mẻ và các bảng điều khiển số thú vị—rất hợp cho buổi chiều!" },
      ...
      s7: { title: "Trở về ga Trung Lịch", subtitle: "🚌 Xe đưa về • Chia sẻ kỷ niệm", summary: "Lên xe đưa đón thoải mái, nghỉ ngơi và chia sẻ những khoảnh khắc vui nhất.", desc: "17:00: Hoàn thiện nhiệm vụ! Thư giãn trên xe riêng. Xem lại những bức ảnh hài hước của cả đoàn trong hành trình và mang những rung cảm Hakka của Daxi về nhà một cách ấm áp!", hl: ["Trở về không mệt mỏi", "Tóm tắt hành trình phiêu lưu", "Gắn kết & Chia sẻ ấm lòng"], tips: "Dự kiến 30 phút về đến nơi. Hãy chợp mắt một lát để nạp lại năng lượng!" },
      s8: { title: "Đến ga Trung Lịch", subtitle: "🚉 Về nhà với niềm vui • Kết thúc", summary: "Về đến nơi lúc ~17:45 với trái tim đầy ắp văn hóa và tiếng cười gia đình.", desc: "17:45: Xe đưa bạn về ga Trung Lịch an toàn. Hành trình khám phá lịch sử, ẩm thực, đồ gỗ và văn học kết thúc với những nụ cười ấm áp. Cha mẹ và trẻ em đã khám phá ra những điều tốt đẹp nhất ở nhau!", hl: ["Về ga Trung Lịch an toàn", "Tràn đầy năng lượng văn hóa", "Gắn kết gia đình vĩnh cửu"], tips: "Đừng quên đồ dùng và huy hiệu kim loại đặc biệt! Chúc bạn lên đường bình an!" }
    }
  };
    ...
    <div className="min-h-screen pt-32 pb-24 bg-hakka-cream selection:bg-hakka-red/20 text-slate-800 relative font-sans">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <section className="relative mb-24">
          ...
          {/* Timeline center line for desktop and tablet */}
          <div className="absolute left-[30px] md:left-1/2 top-10 bottom-10 w-0.5 bg-gradient-to-b from-hakka-red/60 via-hakka-gold/60 to-hakka-green/40 hidden md:block"></div>
            ...
            {stations.map((station, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Desktop and Tablet Timeline Node Ring */}
                  <div className="absolute left-[30px] md:left-1/2 -translate-x-[11px] md:-translate-x-[12px] w-6 h-6 rounded-full bg-white border-4 border-hakka-red z-20 flex items-center justify-center pointer-events-none">
