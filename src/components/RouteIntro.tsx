...
export const RouteIntro = () => {
  ...
  const translations: any = {
    "zh-TW": {
      ...
      s8: { title: "抵達中壢火車站", subtitle: "🚉 滿載而歸・冒險圓滿落幕", summary: "大約 17:30 抵達中壢火車站，收穫感動與代際歡笑、完美散會！", desc: "17:30 包車安穩將大家送抵出發起點「中壢火車站」，這場融合歷史、美食、木藝卡榫、客語與文學的一日深度探險在暖心的笑容中歡樂成行、圓滿落幕！大人與孩子都在通力協作中看見了彼此更棒的一面！", hl: ["安全返回中壢車站", "帶走充實的文化能量", "永遠封存的親子默契"], tips: "下車時別忘了隨身攜帶您的冒險包道具和特製實體金屬徽章喔，祝大家回程平順！" }
    },
    "zh-CN": {
      back: "返回首页",
      ...
      s8: { title: "抵达中坜火车站", subtitle: "🚉 满载而归・冒险圆满落幕", summary: "大约 17:30 抵达中坜火车站，收获感动与代际欢笑、完美散会！", desc: "17:30 包车安稳将大家送抵出发起点“中坜火车站”，这场融合历史、美食、木艺榫卯、客语与文学的一日深度探险在暖心的笑容中欢乐成行、圆满落幕！大人与孩子都在通力协作中看见了彼此更棒的一面！", hl: ["安全返回中坜车站", "带走充实的文化能量", "永远封存的亲子默契"], tips: "下车时别忘了随身携带您的冒险包道具和特制实体金属徽章喔，祝大家回程平顺！" }
    },
    "en": {
      back: "Back Home",
